import type { CashFlowTransaction, CashFlowDay, CashFlowType } from '../types/finance';
...
export function validateCashFlow(data: Partial<CashFlowFormData>): string | null {
...
export function buildCashFlowTransaction(data: CashFlowFormData, existingId?: string): CashFlowTransaction {
  return {
...
export function aggregateToDays(transactions: CashFlowTransaction[]): CashFlowDay[] {
